...
//        setImageView(imageView: recipientImageView, user: recipient)
        ...
        tableView.register(UINib(nibName: "CommentHeaderCell", bundle: nil), forCellReuseIdentifier: "CommentHeaderCell")
...
//    }
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return comments.count + 2 // For CommentHeader Cell and Add Comment Cell
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        
        if(indexPath.row == 0){
            let commentHeaderCell = tableView.dequeueReusableCell(withIdentifier: "CommentHeaderCell", for: indexPath) as! CommentHeaderCell
            commentHeaderCell.team = team
            commentHeaderCell.post = post
